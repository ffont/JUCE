...
try:
    ...
    cd {}; 
    . {};
    echo "Symlinking JUCE distro";
    ln -s /workdir/JUCE_ffont/ /home/sdkuser/JUCE;
    echo "Compiling RASPA<>JUCE example";
    cd /workdir/JUCE_ffont/extras/MinimalExampleELKDrivers/Builds/LinuxMakefile;
    make clean;
